    ...
    try {
        ...
        if (!query || query.startsWith('.')) {
            return await sock.sendMessage(chatId, { 
                text: "*ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀɴ ɪɴsᴛᴀɢʀᴀᴍ ʟɪɴᴋ.*"
            }, { quoted: message });
        }
        ...
        if (!downloadData || !downloadData.data || downloadData.data.length === 0) {
            return await sock.sendMessage(chatId, { 
                text: "*❌ ɴᴏ ᴍᴇᴅɪᴀ ғᴏᴜɴᴅ. ᴛʜᴇ ᴘᴏsᴛ ᴍɪɢʜᴛ ʙᴇ ᴘʀɪᴠᴀᴛᴇ ᴏʀ ᴛʜᴇ ʟɪɴᴋ ɪs ɪɴᴠᴀʟɪᴅ.*"
            }, { quoted: message });
        }
            ...
            try {
                ...
                if (isVideo) {
                    await sock.sendMessage(chatId, {
                        video: { url: mediaUrl },
                        caption: "*ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ʙʏ ᴅʀᴜᴢᴢ x-ᴍᴅ*"
                    }, { quoted: message });
                } else {
                    await sock.sendMessage(chatId, {
                        image: { url: mediaUrl },
        ...
        await sock.sendMessage(chatId, { text: "*❌ ᴇʀʀᴏʀ ᴘʀᴏᴄᴇssɪɴɢ ɪɴsᴛᴀɢʀᴀᴍ ʟɪɴᴋ.*" }, { quoted: message });
    }
}
