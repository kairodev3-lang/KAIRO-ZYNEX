...
async function facebookCommand(sock, chatId, message) {
    try {
        ...
        if (!url.includes('facebook.com')) {
            return await sock.sendMessage(chatId, { 
                text: "*ᴛʜᴀᴛ ɪs ɴᴏᴛ ᴀ ғᴀᴄᴇʙᴏᴏᴋ ʟɪɴᴋ.*"
            }, { quoted: message });
        }
        ...
        if (!fbvid) {
            return await sock.sendMessage(chatId, { 
                text: '*❌ ғᴀɪʟᴇᴅ ᴛᴏ ɢᴇᴛ ᴠɪᴅᴇᴏ ᴜʀʟ ғʀᴏᴍ ғᴀᴄᴇʙᴏᴏᴋ.\n\nᴘᴏssɪʙʟᴇ ʀᴇᴀsᴏɴs:*\n*• ᴠɪᴅᴇᴏ ɪs ᴘʀɪᴠᴀᴛᴇ ᴏʀ ᴅᴇʟᴇᴛᴇᴅ*\n`• ʟɪɴᴋ ɪs ɪɴᴠᴀʟɪᴅ`\n*• ᴠɪᴅᴇᴏ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ғᴏʀ ᴅᴏᴡɴʟᴏᴀᴅ*\n\n*ᴘʟᴇᴀsᴇ ᴛʀʏ ᴀ ᴅɪғғᴇʀᴇɴᴛ ғᴀᴄᴇʙᴏᴏᴋ ᴠɪᴅᴇᴏ ʟɪɴᴋ.*'
            }, { quoted: message });
        }

        // Try URL method first (more reliable)
        try {
            const caption = title ? `*ᴅᴏᴡɴʟᴏᴀᴅ ʙʏ ᴅʀᴜᴢᴢ x-ᴍᴅ*\n\n📝 ᴛɪᴛʟᴇ: ${title}` : "> *©ᴍᴀᴋᴇ ʙʏ ᴅʀᴜᴢᴢ*";
            ...
            console.error(`*ᴜʀʟ ᴍᴇᴛʜᴏᴅ ғᴀɪʟᴇᴅ: ${urlError.message}*`);
            ...
            try {
                ...
                try {
                    ...
                    console.error('ᴇʀʀᴏʀ ᴄʟᴇᴀɴɪɴɢ ᴜᴘ ᴛᴇᴍᴘ ғɪʟᴇ:', err);
                }
                return;
            } catch (bufferError) {
                console.error(`ʙᴜғғᴇʀ ᴍᴇᴛʜᴏᴅ ᴀʟsᴏ ғᴀɪʟᴇᴅ: ${bufferError.message}`);
                throw new Error('Both ᴜʀʟ ᴀɴᴅ ʙᴜғғᴇʀ ᴍᴇᴛʜᴏᴅs ғᴀɪʟᴇᴅ');
            }
        }

    } catch (error) {
        console.error('ᴇʀʀᴏʀ ɪɴ ғᴀᴄᴇʙᴏᴏᴋ ᴄᴏᴍᴍᴀɴᴅ:', error);
        await sock.sendMessage(chatId, { 
            text: "ᴀɴ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀʀᴇᴅ. ᴀᴘɪ ᴍɪɢʜᴛ ʙᴇ ᴅᴏᴡɴ. ᴇʀʀᴏʀ: " + error.message
        }, { quoted: message });
    }
}
