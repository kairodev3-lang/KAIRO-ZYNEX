...
async function kickOfflineCommand(sock, from, msg, isAdmin, botData, saveBotData, args) {
    ...
    if (action === 'on') {
        ...
        saveBotData();
        await sock.sendMessage(from, { text: "✅ *ᴋɪᴄᴋ-ᴏғғʟɪɴᴇ ᴇɴᴀʙʟᴇᴅ!*\n\n*ᴍᴇᴍʙᴇʀs ᴡʜᴏ ʜᴀᴠᴇ ʙᴇᴇɴ ᴏғғʟɪɴᴇ ғᴏʀ ᴍᴏʀᴇ ᴛʜᴀɴ 15 ᴅᴀʏs ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇᴛᴇᴄᴛᴇᴅ ᴀɴᴅ ʀᴇᴍᴏᴠᴇᴅ ᴡʜᴇɴ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪs ᴛʀɪɢɢᴇʀᴇᴅ.*" }, { quoted: msg });
        ...
        saveBotData();
        await sock.sendMessage(from, { text: "❌ *ᴋɪᴄᴋ-ᴏғғʟɪɴᴇ ᴅɪsᴀʙʟᴇᴅ!*" }, { quoted: msg });
    } else {
        await sock.sendMessage(from, { text: "*❌ ᴜsᴀɢᴇ: .ᴋɪᴄᴋᴏғғʟɪɴᴇ [ᴏɴ/ᴏғғ]*" }, { quoted: msg });
    }
}
...
async function performKickOffline(sock, from, botData) {
    try {
        ...
        if (!botIsAdmin) {
            ...
            try {
                ...
                if (!(freshBot?.admin === 'admin' || freshBot?.admin === 'superadmin')) {
                    await sock.sendMessage(from, { text: "*❌ ɪ ɴᴇᴇᴅ ᴛᴏ ʙᴇ ᴀɴ ᴀᴅᴍɪɴ ᴛᴏ ᴋɪᴄᴋ ᴍᴇᴍʙᴇʀs.*" });
                    return;
                }
            } catch (e) {
                await sock.sendMessage(from, { text: "*❌ ɪ ɴᴇᴇᴅ ᴛᴏ ʙᴇ ᴀɴ ᴀᴅᴍɪɴ ᴛᴏ ᴋɪᴄᴋ ᴍᴇᴍʙᴇʀs.*" });
        ...
        await sock.sendMessage(from, { text: "`⚠️ ɴᴏᴛᴇ:` *ᴅᴜᴇ ᴛᴏ ᴡʜᴀᴛsᴀᴘᴘ ᴘʀᴏᴛᴏᴄᴏʟ ʟɪᴍɪᴛᴀᴛɪᴏɴs, ɪ ᴄᴀɴ ᴏɴʟʏ ᴅᴇᴛᴇᴄᴛ 'offline' sᴛᴀᴛᴜs ғᴏʀ ᴍᴇᴍʙᴇʀs ᴡʜᴏsᴇ ᴀᴄᴛɪᴠɪᴛʏ ɪ ʜᴀᴠᴇ ᴛʀᴀᴄᴋᴇᴅ ᴡʜɪʟᴇ ɪ ᴡᴀs ᴏɴʟɪɴᴇ. ɪ ᴡɪʟʟ ᴍᴏɴɪᴛᴏʀ ᴛʜᴇ ɢʀᴏᴜᴘ ᴀɴᴅ ʀᴇᴍᴏᴠᴇ ɪɴᴀᴄᴛɪᴠᴇ ᴍᴇᴍʙᴇʀs ᴏᴠᴇʀ ᴛɪᴍᴇ.*" });

    } catch (e) {
        console.error("*❌ ᴋɪᴄᴋᴏғғʟɪɴᴇ ᴇʀʀᴏʀ:*", e);
    }
}
