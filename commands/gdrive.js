...
async function gdriveCommand(sock, from, msg, q) {
    if (!q) return await sock.sendMessage(from, { text: "*❌ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ʟɪɴᴋ.*" }, { quoted: msg });
    
    await sock.sendMessage(from, { text: "⏳ *ᴀɴᴀʟʏᴢɪɴɢ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ ʟɪɴᴋ...*" }, { quoted: msg });
    ...
    try {
        ...
        if (fileId) {
            ...
            await sock.sendMessage(from, { text: "*❌ ᴄᴏᴜʟᴅ ɴᴏᴛ ᴇxᴛʀᴀᴄᴛ ғɪʟᴇ ɪᴅ ғʀᴏᴍ ᴛʜᴇ ʟɪɴᴋ.*" }, { quoted: msg });
        }
    } catch (e) {
        console.error("GDrive Error:", e);
        await sock.sendMessage(from, { text: "*❌ ᴇʀʀᴏʀ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ғʀᴏᴍ ɢᴅʀɪᴠᴇ:* " + e.message }, { quoted: msg });
    }
}
