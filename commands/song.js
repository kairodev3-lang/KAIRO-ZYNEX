...
async function songCommand(sock, chatId, message) {
    try {
        ...
        if (!query || query.toLowerCase() === '.song') {
            await sock.sendMessage(chatId, { text: '*ᴜsᴀɢᴇ: .sᴏɴɢ <sᴏɴɢ ɴᴀᴍᴇ ᴏʀ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ>*' }, { quoted: message });
            return;
        }
        ...
        await sock.sendMessage(chatId, {
            ...
            caption: `*🎵 ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ: ${video.title}*\n*⏱ ᴅᴜʀᴀᴛɪᴏɴ: ${video.timestamp || 'N/A'}*`
        }, { quoted: message });
        ...
        if (!downloadSuccess) {
            throw new Error('*ᴀʟʟ ᴅᴏᴡɴʟᴏᴀᴅ sᴏᴜʀᴄᴇs ғᴀɪʟᴇᴅ.*');
        }
